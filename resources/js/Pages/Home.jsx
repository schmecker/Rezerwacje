                ...
                <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                    <div className="px-4 py-6 sm:px-0">
                        <div className="border-4 border-dashed border-gray-200 rounded-lg h-96 flex flex-col items-center justify-center">
                            <h2 className="text-2xl font-semibold mb-4">Witamy w naszym systemie zarządzenia przestrzenią</h2>
                            <p className="text-gray-600 mb-8">Łatwo rezerwuj sale spotkań dla swojego zespołu</p>
